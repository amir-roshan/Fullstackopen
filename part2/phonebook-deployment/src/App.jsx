  ...
  const handleSubmit = (event) => {
    ...
    if (isNameSimilar) {
      if (
        ...
        phoneNumberService
          .update(similarPerson)
          .then((response) =>
            setPersons(
              persons.map((person) =>
                person.id !== similarPerson.id ? person : response.data
              )
            )
          );
  ...
  return (
    <div>
      ...
      <PersonForm
        ...
        onNameChange={handlePhoneName}
        onPhoneNumChange={handlePhoneNUmber}
        onName={newName}
